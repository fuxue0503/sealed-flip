              ...
              <div key={project.id} className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all group flex flex-col">
                 <div className="relative aspect-[4/3] bg-gray-100 p-6 md:p-8 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className={`px-2.5 py-1 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 ${
                 ...
                 <div className="p-6 md:p-8 flex-1 flex flex-col space-y-5 md:space-y-6">
                    ...
                    <div className="flex items-center justify-between pt-1 md:pt-2">
                       ...
                       <button 
                        ...
                        className={`px-6 md:px-8 py-2.5 md:py-3 rounded-xl font-black uppercase italic text-[10px] md:text-xs tracking-[0.15em] shadow-lg transition-all ${
                          isLive ? 'bg-blue-600 text-white hover:bg-blue-700 shadow-blue-600/20 active:scale-95' :
